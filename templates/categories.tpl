...
<table class="table">
 <thead class="thead-dark">
    <tr>
        <td scope="row" class="p-3 mb-2 bg-warning text-dark">Nombre</td>
        <td scope="row" class="p-3 mb-2 bg-warning text-dark">Descripcion</td>
        <td scope="row" class="p-3 mb-2 bg-warning text-dark">Ver más</td>
    </tr>
 </thead>
   <tbody>
